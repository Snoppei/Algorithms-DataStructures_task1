...
public class StackGenerics<T> {  // стек на основе generic (обобщенные переменные итд)
    ...
    /*Метод обратной матрицы, метод Крамара, метод Гауса (неоднородная система уравнений, треугольный вид, ранг)
    * ОБЩЕЕ РЕШЕНИЕ 3 варианта решения системы в ОДНОМ ИНТЕРФЕЙСЕ, пишу калькулятор, продумать кнопки и тд.*/
